...
function ReturnOrderDetail() {
    ...
    const totalAmount = phieuTraHang.chiTietTraHang?.reduce((sum, chiTiet) => {
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border ${getStatusStyle(phieuTraHang.trangThai)}`}>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 flex items-center gap-1">
                                        ...
                                        {phieuTraHang.ngayXuLy ? dayjs(phieuTraHang.ngayXuLy).format('DD/MM/YYYY HH:mm') : 'Chưa xử lý'}
                                    </p>
                                </div>
                            </div>
                            ...
                            {phieuTraHang.ghiChuKhachHang && (
                                <div className="mt-4">
                                    ...
                                    <p className="text-gray-800 bg-gray-50 p-3 rounded-lg mt-1">{phieuTraHang.ghiChuKhachHang}</p>
                                </div>
                            )}
                        </div>
                                                ...
                                                <div className="flex-grow min-w-0">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-600 mb-3">
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <span><strong>Thương hiệu:</strong> {sanPham?.tenThuongHieu || 'N/A'}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Tag className="w-4 h-4" />
                                                            <span><strong>Màu sắc:</strong> {sanPham?.tenMauSac || 'N/A'}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Tag className="w-4 h-4" />
                                                            <span><strong>Chất liệu:</strong> {sanPham?.tenChatLieu || 'N/A'}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Tag className="w-4 h-4" />
                                                            <span><strong>Trọng lượng:</strong> {sanPham?.tenTrongLuong || 'N/A'}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Tag className="w-4 h-4" />
                                                            <span><strong>Điểm cân bằng:</strong> {sanPham?.tenDiemCanBang || 'N/A'}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Tag className="w-4 h-4" />
                                                            <span><strong>Độ cứng:</strong> {sanPham?.tenDoCung || 'N/A'}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                                        ...
                                                        <div className={`p-3 rounded-lg ${soLuongPheDuyet > 0 ? 'bg-green-50' : 'bg-yellow-50'}`}>
                                                            <div className={`font-medium ${soLuongPheDuyet > 0 ? 'text-green-800' : 'text-yellow-800'}`}>
                                                                Số lượng duyệt
                                                            </div>
                                                    ...
                                                    {chiTiet.lyDoTraHang && (
                                                        <div className="mt-3 p-3 bg-red-50 rounded-lg">
                                                            <div className="font-medium text-red-800 mb-1">Lý do trả hàng:</div>
                                                    ...
                                                    {chiTiet.ghiChuNhanVien ? (
                                                        <div className="mt-3 p-3 bg-yellow-50 rounded-lg">
                                                            <div className="font-medium text-yellow-800 mb-1">Ghi chú nhân viên:</div>
                                                            <div className="text-yellow-700">{chiTiet.ghiChuNhanVien}</div>
                                                        </div>
                                                    ) : (
                                                        <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                                                            <div className="font-medium text-gray-600 mb-1">Ghi chú nhân viên:</div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="font-semibold text-gray-800">
                                        {phieuTraHang.chiTietTraHang?.reduce((sum, chiTiet) => sum + (chiTiet.soLuongPheDuyet || 0), 0) || 0}
                                    </span>
                                </div>
