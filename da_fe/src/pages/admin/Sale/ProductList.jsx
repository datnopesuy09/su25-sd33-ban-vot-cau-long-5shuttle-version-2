        ...
        <div className="bg-gray-50 p-4">
            <div className="max-w-6xl mx-auto">
                ...
                {orderDetailDatas.map((orderDetail) => {
                    const originalPrice = orderDetail.sanPhamCT.donGia;
                    const promotionalPrice = orderDetail.sanPhamCT.giaKhuyenMai;
                    const discountPercentage = promotionalPrice
                        ? (((originalPrice - promotionalPrice) / originalPrice) * 100).toFixed(0)
                        : 0; // Set discount to 0 if promotionalPrice is null
                                                    ...
                                                    {promotionalPrice !== null ? (
                                                        <>
                                                            ...
                                                            <span className="text-sm text-red-500">
                                                                {promotionalPrice.toLocaleString()} VNĐ
                                                            </span>
                                                        </>
                                                    ) : (
