...
function PhieuGiamGia() {
    ...
    return (
        <div>
            <div className="font-bold text-sm">Phiếu giảm giá</div>
            ...
            <div className="bg-white p-4 rounded-md shadow-lg">
                ...
                <div className="flex space-x-4 pt-4 pb-4">
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <div className="flex w-1/2 gap-4">
                            {' '}
                            {/* Đặt w-1/2 để bằng input tìm kiếm */}
                            <DateTimePicker
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <option value={0} className="bg-white text-gray-700">
                                    Phần trăm
                                </option>
                                <option value={1} className="bg-white text-gray-700">
                                    Giá tiền
                                </option>
                            </select>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <option value={2} className="bg-white text-gray-700">
                                    Đã kết thúc
                                </option>
                            </select>
                ...
                {/* table */}
                <table className="min-w-full table-auto border border-gray-300 rounded-md overflow-hidden shadow-sm text-sm">
                    <thead className="bg-gray-100 text-gray-700 font-medium uppercase">
                        <tr>
                    ...
                    <tbody>
                        {listVoucher && listVoucher.length > 0 ? (
                            listVoucher.map((item, index) => (
                                <tr key={index} className="over:bg-gray-50 border-t border-gray-200 text-sm">
                                    <td className="py-2 px-4">{index + 1}</td>
                                    <td className="py-2 px-4">{item.ma}</td>
                                    <td className="py-2 px-4">{item.ten}</td>
                    ...
                    item.trangThai === 2
                        ...
                        : item.trangThai === 1
                          ...
                          : 'bg-yellow-100 text-yellow-700 border-yellow-400'
                                            ...
                                            onClick={
                                                item.trangThai === 2 ? undefined : () => handelDeleteVoucher(item.id)
                                            }
                                        >
                                            {item.trangThai === 2
                                                ? 'Đã kết thúc'
                            ...
                            <tr>
                                <td colSpan="9" className="py-4 text-center text-gray-500 italic bg-white">
